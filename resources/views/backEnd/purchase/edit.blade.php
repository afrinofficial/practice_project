                    ...
                    <form action="{{route('update.purchase')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="title" value="{{$purchase->title}}">
                                    </div>
                                        ...
                                        <div class="input-group">
                                            <select name="supplier_id" class="form-control form-select">
                                                ...
                                                @foreach($suppliers as $row)
                                                    <option value="{{$row->id}}" @if($row->id == $purchase->supplier_id) selected @endif>{{$row->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="status" id="" class="form-control">
                                            <option value="1" @if($row->status == 1) selected @endif>Received</option>
                                            <option value="2" @if($row->status == 2) selected @endif>Pending</option>
                                            <option value="2" @if($row->status == 3) selected @endif>Ordered</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <ul class="list-group" style="display: block; position: relative; z-index: 1" id="search-results"></ul>
                            </div>
                            <div class="col-md-2"></div>
                                        ...
                                        <table class="table table-hover table-bordered">
                                            ...
                                            @foreach($products as $index => $product)
                                                <tr data-id="{{ $product->id }}">
                                                    <td>{{ $index + 1 }}</td>
                                                    <td><img src="{{ asset($product->products->image) }}" alt="Product Image" class="img-fluid w-25"></td>
                                                    <td>{{ $product->products->name }}</td>
                                                    <td style="display:none;"><input type="hidden" name="product_id[]" value="{{ $product->id }}" class="form-control"></td>
                                                    <td><input type="number" name="price[]" value="{{ $product->price }}" step="1" class="form-control price-input"></td>
                                                    <td><input type="number" name="total_quantity[]" value="{{ $product->total_quantity }}" step="1" class="form-control qty-input"></td>
                                                    <td class="total-price">{{ $product->price * $product->total_quantity }}</td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="">
                                                ...
                                                <input type="number" class="form-control" id="total-price-main" name="total_amount" placeholder="" value="{{$purchase->total_amount}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="">
                                                ...
                                                <select name="payment_type" id="" class="form-control">
                                                    <option value="1" @if($purchase->payment_type == 1) selected @endif>Cash</option>
                                                    <option value="2" @if($purchase->payment_type == 2) selected @endif>Check</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="">
                                                ...
                                                <textarea type="text" class="form-control" id="payment_note" name="description" placeholder="">{{$purchase->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
