        ...
        <div class="overview">
            <div class="recent--tables reccent_tables">
                <div class="title tadd">
                    <h4>@yield('title')</h4>
                    <a class="add" href="{{route('supplier.create')}}"><i class="ri-add-line"></i>Add Suppliers</a>
                </div>
                <hr>
                    ...
                    <table id="dataTable2">
                        ...
                        @foreach($supplier as $row)
                            <tr>
                                ...
                                <td class="acts">
                                <span> <a href="{{route('edit.supplier', $row)}}"> <i class="ri-edit-line edit"></i></a>
                                    <a href="{{ route('delete.supplier', ['id' => $row->id]) }}" onclick="return confirm('Are you sure you want to delete this category?');">
