        ...
        <div class="overview">
            <div class="recent--tables reccent_tables">
                <div class="title tadd">
                    <h4>@yield('title')</h4>
                    <a class="add" href="{{route('category.create')}}"><i class="ri-add-line"></i>Add Category</a>
                </div>
                        ...
                        <tr>
                            ...
                            <td class="acts">
                                <span> <a href="{{route('category.update', $row)}}"> <i class="ri-edit-line edit"></i></a>
                                    <a href="{{ route('category.delete', ['id' => $row->id]) }}" onclick="return confirm('Are you sure you want to delete this category?');">
